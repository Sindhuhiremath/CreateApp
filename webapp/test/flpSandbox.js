		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sfscreate",
									"targetURL": "#comarteriatechsfcrtcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comarteriatechsfcrtcreate-display": {
								"semanticObject": "comarteriatechsfcrtcreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.arteriatech.sfcrt.create",
									"url": sap.ui.require.toUrl("com/arteriatech/sfcrt/create")
								}
							}
						}
					}
