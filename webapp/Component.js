...
sap.ui.define([
        ...
        "sap/ui/Device",
        "com/arteriatech/sfcrt/create/model/models"
    ],
    function (UIComponent, Device, models) {
        "use strict";

        return UIComponent.extend("com.arteriatech.sfcrt.create.Component", {
            metadata: {
                manifest: "json"
            },
             ...
             */
            init: function () {
                var sAppModulePath = jQuery.sap.getModulePath("com.arteriatech.sfcrt.create")
